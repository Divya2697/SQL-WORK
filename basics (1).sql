...
--
DELIMITER $$
CREATE TRIGGER `new` AFTER DELETE ON `student2` FOR EACH ROW INSERT into employee (NAME) VALUES ('divya')
$$
DELIMITER ;
...
--
ALTER TABLE `student2`
  MODIFY `SNO` int(90) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

DELIMITER $$
--
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `test_event_01` ON SCHEDULE AT '2018-07-12 14:39:31' ON COMPLETION NOT PRESERVE ENABLE DO INSERT INTO messages(message,created_at)
